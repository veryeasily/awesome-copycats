...
theme.layout_txt_centerworkh                    = "[centerwork-h]"
...
-- Textclock
local mytextclock = wibox.widget.textclock(markup(white, " %I:%M %p "))
...
theme.fs = lain.widget.fs({
    notification_preset = { fg = white, bg = theme.bg_normal, font = "Tamsyn 10.5" },
    settings  = function()
